object FrmPrincipal: TFrmPrincipal
  ...
  object Panel1: TPanel
    ...
    object Panel2: TPanel
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Height = 536
        Selected.Strings = (
          'ITEM'#9'6'#9'ITEM'#9'F'#9
          'DESCRICAO'#9'30'#9'DESCRI'#199#195'O'#9'F'#9
          'QTDE'#9'6'#9'QTDE'#9'F'#9
          'VALOR'#9'7'#9'VALOR'#9'F'#9
          'TOTAL'#9'7'#9'TOTAL'#9'F'#9)
    ...
    object Panel3: TPanel
      ...
      ParentFont = False
      TabOrder = 1
      object btnFinalizarVenda: TsButton
        Left = 8
        Top = 8
        Width = 201
        Height = 49
      ...
      object btnCancelarItem: TsButton
        Left = 8
        Top = 59
        Width = 201
        Height = 49
      ...
      object btnAdicionais: TsButton
        Left = 1158
        Top = 8
        Width = 201
        Height = 49
        Caption = 'F7 - Adicionais'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWhite
        Font.Height = -16
        Font.Name = 'Verdana'
        ...
        ParentFont = False
        TabOrder = 4
        OnClick = btnAdicionaisClick
        SkinData.SkinSection = 'BUTTON'
      end
      object btnCancelarVenda: TsButton
        Left = 1158
        Top = 59
        Width = 201
        Height = 49
        Caption = 'F8 - Cancelar Venda'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWhite
        Font.Height = -16
        Font.Name = 'Verdana'
      ...
      object btnRelVendaDia: TsButton
        Left = 955
        Top = 8
        Width = 201
        Height = 49
        Caption = 'F5 - Vendas do Dia'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWhite
        Font.Height = -16
        Font.Name = 'Verdana'
    ...
    object Panel4: TPanel
      ...
      object PCancelaItem: TPanel
        ...
        object EditCancelarItem: TsEdit
          Left = 16
          Top = 72
          Width = 241
          Height = 40
          ...
          ParentFont = False
          TabOrder = 1
          OnChange = EditCancelarItemChange
          OnKeyDown = EditCancelarItemKeyDown
      ...
      object pnlPeso: TPanel
        ...
        object jvPeso: TRxCalcEdit
          ...
          ParentFont = False
          TabOrder = 1
          OnKeyDown = jvPesoKeyDown
          OnKeyPress = jvPesoKeyPress
        end
      end
    end
  end
  object rxTemp: TRxMemoryData
    FieldDefs = <>
    Left = 674
    Top = 137
    object rxTempITEM: TIntegerField
      DisplayWidth = 6
      FieldName = 'ITEM'
      DisplayFormat = '000000'
    end
    object rxTempDESCRICAO: TStringField
      DisplayLabel = 'DESCRI'#199#195'O'
      DisplayWidth = 30
      FieldName = 'DESCRICAO'
      Size = 60
    end
    object rxTempQTDE: TFloatField
      DisplayWidth = 6
      FieldName = 'QTDE'
      DisplayFormat = '0.00'
    end
    object rxTempVALOR: TFloatField
      DisplayWidth = 7
      FieldName = 'VALOR'
      DisplayFormat = '###,###,##0.00'
    end
    object rxTempTOTAL: TFloatField
      DisplayWidth = 7
      FieldName = 'TOTAL'
      DisplayFormat = '###,###,##0.00'
    end
    object rxTempCODIGO: TIntegerField
    ...
    object rxTempADICIONAL: TStringField
      DisplayWidth = 1
      FieldName = 'ADICIONAL'
      Visible = False
      Size = 1
    end
    object rxTempCODKIT: TIntegerField
      DisplayLabel = 'C'#211'D KIT'
      FieldName = 'CODKIT'
      DisplayFormat = '000000'
    end
  end
  ...
  object sSkinManager1: TsSkinManager
    ...
    SkinDirectory = 
      'C:\PASTA DE CLIENTES\Componentes\AlphaControls v6.43 Delphi 7, 2' +
      '007, 2009\Skins'
    SkinName = 'Beijing (internal)'
    SkinInfo = '7.2'
    ThirdParty.ThirdEdits = ' '#13#10'T'#13#10
  ...
  object UserControl1: TUserControl
    AutoStart = True
    ApplicationID = 'SUPERMIXPDV'
    ControlRight.MainMenu = MainMenu1
    User.MenuItem = Cadastrar1
    UserPasswordChange.MenuItem = AlterarSenha1
    UsersLogoff.MenuItem = rocarUsuario1
    LogControl.TableLog = 'UCLog'
    Language = ucPortuguesBr
    EncryptKey = 0
    Login.InitialLogin.User = 'admin'
    Login.InitialLogin.Email = 'controldinformatica@gmail.com'
    Login.InitialLogin.Password = 'admin@1234'
  ...
  object RDprint1: TRDprint
    ...
    Margens.Bottom = 10
    Autor = Deltress
    RegistroUsuario.NomeRegistro = 'JNP SOFTWARE DE FRANCA LTDA'
    RegistroUsuario.SerieProduto = 'SINGLE-1111/00996'
    RegistroUsuario.AutorizacaoKey = 'RPTG-ZDD2-964M-ACCC-4R5P'
  ...
  object QryVendasDoDia: TZQuery
    Connection = DM.Conexao
    SQL.Strings = (
      
        'SELECT SUM(DESCONTO) AS DESCONTO,NOME_PGTO,SUM(TOTAL) AS TOTAL, ' +
        'CAST(DATA_VENDA AS DATE) AS DATA_VENDA FROM VENDAS'
      
        'WHERE CAST(DATA_VENDA AS DATE) >=:D1 AND CAST(DATA_VENDA AS DATE' +
        ') <=:D2'
      ''
      'GROUP BY NOME_PGTO,CAST(DATA_VENDA AS DATE)'
      'ORDER BY NOME_PGTO ASC')
    Params = <
      item
        DataType = ftUnknown
        Name = 'D1'
    ...
    object QryVendasDoDiaNOME_PGTO: TStringField
      FieldName = 'NOME_PGTO'
    end
    object QryVendasDoDiaTOTAL: TFloatField
      FieldName = 'TOTAL'
      ReadOnly = True
    end
    object QryVendasDoDiaDATA_VENDA: TDateField
      FieldName = 'DATA_VENDA'
      ReadOnly = True
    end
    object QryVendasDoDiaDESCONTO: TFloatField
      FieldName = 'DESCONTO'
      ReadOnly = True
    end
  end
